...
namespace Sistema.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        // GET: Categorias
        public async Task<IActionResult> Index(string O,string search,string filtro,int?page)
        {
            ViewData["Nombre"] = String.IsNullOrEmpty(O) ? "nombre_desc" : "";
            ViewData["Descripccion"] = O == "descripcion_asc" ? "descripcion_desc" : "descripcion_asc";
